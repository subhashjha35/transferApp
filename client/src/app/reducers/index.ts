...
export const getTransactionState = createFeatureSelector<transactionReducers.TransactionState>('transactions');

export const getAllTransactions = createSelector(getTransactionState, (state) => state.list);
